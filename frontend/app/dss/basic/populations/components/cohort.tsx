...
const Cohort: React.FC<CohortProps> = ({ cohortData }) => {
  ...
  const pyramidChartOptions: ChartOptions<'bar'> = {
    indexAxis: 'y' as const, // Explicitly type as 'y' for horizontal bars
    scales: {
      x: {
        stacked: true,
        title: {
      ...
      y: {
        ...
        reverse: false, // Matches reversed pyramidAgeGroups
      },
    },
    plugins: {
      legend: {
